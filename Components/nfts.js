...
function Products(props) {
  const getImageUrl = (assetContract, imageUrl) => {
    if (imageUrl !== undefined) {
      return imageUrl;
    } else {
      return assetContract?.imageUrl;
    }
  }
  return (
    <>
            ...
            <ProductCardContainer key={index} className={"p-1"}>
              ...
              >
                ...
                <CardImage className={`p-1 text-center`}>
                  <Link
                    href={`/nft/${n?.assetContract?.address
                  ...
                  >
                    <a>
                      <NFTImage>
                        <Image
                          src={getImageUrl(n.assetContract, n.imageUrl ? n.imageUrl : n?.metadata?.image)}
                          className="rounded"
                          preview={false}
                          alt=""
                        />
