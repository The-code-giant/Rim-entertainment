...
import { accountList, isMobileDevice } from "../Constants/constants";
import { useStoreApi } from "../Providers/storeApi";
import { useWeb3 } from "../Providers/getWeb";
import Link from "next/link";
import { getAccountToken, setAccountToken } from "../store/action/accountSlice";
...
export default function Header(props) {
  ...
  const menu1 = (
    <Menu>
      ...
      <Menu.Item>{menuFooter}</Menu.Item>
    </Menu>
  );
  ...
  return (
    <nav className={`${styles.mainNav} ${styles.pageHeader}`}>
      ...
      <div
        ...
        style={{ flex: "1", marginRight: "400px" }}
      >
        <Search />
      </div>
